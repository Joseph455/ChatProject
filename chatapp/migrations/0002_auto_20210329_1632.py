# Generated by Django 3.0.9 on 2021-03-29 16:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RenameModel(
            old_name='ChatReciever',
            new_name='ChatReceiver',
        ),
        migrations.RenameField(
            model_name='chatreceiver',
        ...
        migrations.AddField(
            model_name='chat',
            name='receivers',
            field=models.ManyToManyField(related_name='received_chats', through='chatapp.ChatReceiver', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='file',
            name='chat',
        ...
        migrations.AddField(
            model_name='image',
            name='message',
            field=models.ManyToManyField(related_name='images', to='chatapp.Message'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='userstate_set', to='chatapp.Group')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='group_state', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
