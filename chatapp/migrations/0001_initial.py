    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='created_channels', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chats', to='chatapp.Channel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, max_length=50)),
                ('title_slug', models.SlugField(blank=True, null=True)),
                ('icon', models.ImageField(default='chatapp/groups/icons/default.png', max_length=150, upload_to='chatapp/groups/icons')),
                ('closed', models.BooleanField(default=False)),
                ('date_created', models.DateField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reaction', models.CharField(choices=[('Like', 'Like'), ('Hate', 'Hate'), ('Happy', 'Happy'), ('Sad', 'Sad'), ('Upvote', 'Upvote'), ('DownVote', 'Downvote')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text_content', models.TextField(blank=True, max_length=300, null=True)),
                ('is_code', models.BooleanField(default=False)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('chat', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='chatapp.Chat')),
            ],
        ),
        migrations.CreateModel(
            name='Membership',
            fields=[
                ...
                ('channel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='chatapp.Channel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(max_length=150, upload_to='chatapp/users/images/%Y%m%d')),
                ('message', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='chatapp.Message')),
            ],
        ),
        migrations.CreateModel(
            name='GroupInvite',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('duration', models.CharField(choices=[('1', '1 day'), ('2', '2 days'), ('3', '3 days'), ('4', '4 days'), ('5', '5 days'), ('6', '6 days'), ('7', '7 days'), ('8', '8 days'), ('9', '9 days'), ('10', '10 days')], default='1', help_text='Duration between 1-10 days', max_length=2)),
                ('signed_value', models.CharField(blank=True, default='', max_length=150)),
                ('link', models.URLField(blank=True, null=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invites', to='chatapp.Group')),
            ],
        ),
        migrations.AddField(
            model_name='group',
            name='members',
            field=models.ManyToManyField(through='chatapp.Membership', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='File',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(max_length=150, null=True, upload_to='chatapp/users/files/%Y%m%d')),
                ('message', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='chatapp.Message')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('Delete:Chat', 'Delete:Chat'), ('Add:Group', 'Add:Group'), ('Remove:Group', 'Remove:Group'), ('Add:Channel', 'Add:Channel'), ('Remove:Channel', 'Remove:Channel'), ('Create:Group', 'Create:Group'), ('Create:Channel', 'Create:Channel'), ('Add:Member', 'Add:Member'), ('Remove:Member', 'Remove:Member')], default='Delete:Chat', max_length=50)),
                ('carrier', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='com_notifiyer_Cset', to=settings.AUTH_USER_MODEL)),
                ('chat', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='notifiyer', to='chatapp.Chat')),
                ('recipient', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='com_notifiyer_Rset', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Code',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='chatapp.Chat')),
        ...
        migrations.AddField(
            model_name='chat',
            name='conversation',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chats', to='chatapp.Conversation'),
        ),
        migrations.AddField(
            model_name='chat',
            name='creator',
        ...
        migrations.AddField(
            model_name='chat',
            name='recievers',
            field=models.ManyToManyField(related_name='recieved_chats', through='chatapp.ChatReciever', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='chat',
            name='replying',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies_set', to='chatapp.Chat'),
        ),
        migrations.AddField(
            model_name='channel',
            name='group',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='channels', to='chatapp.Group'),
        ),
        migrations.AddField(
            model_name='channel',
            name='members',
